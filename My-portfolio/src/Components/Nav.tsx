...
const Nav = () => {
  return (
    <div className="bg-green-500 flex justify-between px-4 items-center">
        
        {/* <div>
      <button className="relative group">
        <div className="relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all bg-gray-200 ring-0 ring-gray-300 hover:ring-8 group-focus:ring-4 ring-opacity-30 duration-200 shadow-md">
