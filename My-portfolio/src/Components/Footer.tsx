...
const Footer = () => {
  return (
    <div className="pt-4">
      <hr />
      <div className="flex justify-between items-center bg-gren-400 h-24">
        <section className=" bg-rd-600 max-sm">
          <p className="ml-4 text-lg font-semibold">Dannie.</p>
        </section>
        <section className="m-auto w-1/5 bg-red-600">
          <div className=" h-6 flex items-center gap-6">
            ...
            <a href="http://"  className="h-full w-6" target="blank" ><img src={Twitter} alt="" className="h-full" /></a>
          </div>
        </section>
        <div className="h-12 ">
